...
const PAYLOAD = ["bin", "lib", "package.json", "CHANGELOG.md"];
...
export async function currentVersion() {
  return versionIn(await installRoot());
}
...
export async function checkUpdate() {
  ...
  return { root, staged, changed, from: await versionIn(root), to: await versionIn(staged) };
}
